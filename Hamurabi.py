...
class Hammurabi:
    ...
    def askHowManyAcresToBuy(self, price, bushels):
        ...
        while answer>max_acres:
            answer=int(input(f"THINK AGAIN, O MIGHTY MASTER. YOU ONLY HAVE ENOUGH BUSHELS TO BUY {max_acres} ACRES. HOW MANY ACRES OF LAND DO YOU PLAN ON BUYING?:"))
        
        self.acres+=answer
        self.bushels-=(answer*self.price)

        return [self.acres, self.bushels]
    ...
    def askHowManyAcresToSell(self, acresOwned):
        ...
        while answer>self.acres:
            answer=int(input(f"THINK AGAIN, O MIGHTY MASTER. YOU ONLY HAVE {self.acres} ACRES. HOW MANY ACRES OF LAND DO YOU PLAN ON SELLING?:"))
    ...
    def askHowMuchGrainToFeedPeople(self, bushels):
        ...
        bushels_used=self.people*20 #Each person needs at least 20 bushels of grain per year to survive
    ...
    def askHowManyAcresToPlant(self, acresOwned, population, bushels):
        ...
        while answer>self.bushels//2 or answer>self.people*10 or answer>self.acres:
            ...
            while answer>self.people*10: #Each person can farm at most 10 acres of land
                answer=int(input(f"THINK AGAIN, O MIGHTY MASTER. YOU ONLY HAVE ENOUGH PEOPLE TO PLANT {self.people10} ACRES. NOW, THEN, HOW MANY ACRES DO YOU WISH TO PLANT WITH SEED?: "))
            while answer>self.acres:
